...
public class Circle extends SimpleShape {
    ...
    public Circle(int x, int y) {
        super(x, y);
        this.circleShape = new Ellipse2D.Double(this.x, this.y, size, size);
    }
    ...
    public void setCoordinates(int x, int y) {
        this.x = x;
        this.y = y;
        this.circleShape.setFrame(x, y, size, size);
    }
    ...
    public void applySize(Graphics2D g2, int size) {
        ...
        this.size = size;
        this.circleShape.setFrame((double)x - halfDifference, (double)y - halfDifference, size, size);
        draw(g2);
    }
